...
INSERT INTO `info_pages` VALUES (1,'Main page',NULL,'','all','1','Main page','main',NULL,NULL,'MAIN PAGE!!!',0,NULL),(3,'Top page',1,'icon-glass','top','1','top page','common',NULL,NULL,'top page',0,NULL),(4,'Sidebar page',3,'icon-align-justify','sidebar','1','sidebar page','common',NULL,NULL,'sidebar page',0,NULL),(5,'For teachers',2,'menu-teachers-icon.png','sidebar','1','For teachers','special',NULL,NULL,'<p><h3>Для учителей: </h3></p> <ul><li>Good-bye</li><li>и т.д.</li></ul>',0,NULL),(6,'For parents',1,'menu-parents-icon.png','sidebar','1','For parents','special',NULL,NULL,'<p><h3>Для родителей: </h3></p> <ul><li>Hello!</li><li>и т.д.</li></ul>',0,NULL);
...
INSERT INTO `teachers_and_director` VALUES (1,'NO','Марат','Стамескин','Рубанкович','MarRub009','7razOtmer,1RazOtrezh','труд, технология',50,'+7(951)675-44-07','marat_rub@mail.ru'),(2,'NO','Валентина','Гваделупова','Аргентинова','ValArg','1100GvAr','география',36,'+7(900)109-55-41','val_arg@inbox.ru');
...
-- Dump completed on 2018-08-22 23:13:49
